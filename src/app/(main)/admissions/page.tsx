  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <h2 className="font-serif text-4xl font-semibold mb-12 text-center">Application Process</h2>
          <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Complete our online application form</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-sm text-muted-foreground">Tour our campus and meet our staff</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Receive decision and complete enrollment</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <h2 className="font-serif text-4xl font-semibold mb-12 text-center">Important Dates</h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <h2 className="font-serif text-4xl font-semibold mb-6">Ready to Apply?</h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Start your application today or schedule a campus visit to learn more
          </p>
